...
gRecordset.Open vQuery, vGetConnect, adOpenDynamic, adLockOptimistic
...
If vGetConnect.State = 0 Then
    vGetconnectString = "Provider = SQLOLEDB.1;Persist Security Info = False;User ID = vbuser;Password = 132;Data Source = S02DB;Initial Catalog = BCNP"
