...
If TXT021.Text <> "" And TXT022.Text <> "" Then
  ...
  If vDocTypeID = "INV" Then
            ...
            ElseIf TXT022.Text = "พิมพ์ใบเสร็จ" Then
                Call PrintInvoice
            ElseIf TXT022.Text = "พิมพ์ใบเสร็จ เฉพาะกิจ" Then
...
On Error GoTo ErrDescription
        ...
        '---------------------------------------------------------------------------------------------
                            ...
                            vRepType = "RT"
                            If UCase(vGroupDoc) = "RHV" Or UCase(vGroupDoc) = "RXT" Or UCase(vGroupDoc) = "RDV" Or UCase(vGroupDoc) = "RAB" Or UCase(vGroupDoc) = "RDM" Then
                                vRepID = 64
                            ElseIf UCase(vGroupDoc) = "RHN" Or UCase(vGroupDoc) = "RDN" Then
                                vRepID = 65
                            ElseIf UCase(vGroupDoc) = "RCV" Or UCase(vGroupDoc) = "RVD" Or UCase(vGroupDoc) = "RVM" Then
                                vRepID = 135
