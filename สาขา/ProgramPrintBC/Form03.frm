...
vQuery = "exec dbo.USP_NP_SearchCheckShelfSaleOrderDataPickZone '" & vDocNo & "' "
If OpenDataBase(gConnection, vRecordset, vQuery) <> 0 Then
...
If Me.Text101.Text <> "" Then
  ...
  vQuery = "exec dbo.USP_SO_SaleOrderPickingPickZone '" & vDocNo & "' "
  If OpenDataBase(gConnection, vRecordset, vQuery) <> 0 Then
