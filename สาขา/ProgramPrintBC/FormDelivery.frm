...
Begin VB.Form FormDelivery 
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      Tab(0).Control(0)=   "Text104"
      Tab(0).Control(1)=   "Text105"
      Tab(0).Control(2)=   "CMD108"
      Tab(0).Control(3)=   "CMD107"
      Tab(0).Control(4)=   "MaskEdBox102"
      Tab(0).Control(5)=   "MaskEdBox101"
      Tab(0).Control(6)=   "DTPicker103"
      Tab(0).Control(7)=   "DTPicker102"
      Tab(0).Control(8)=   "DTPicker101"
      Tab(0).Control(9)=   "Text107"
      Tab(0).Control(10)=   "Text106"
      Tab(0).Control(11)=   "Text103"
      Tab(0).Control(12)=   "Text108"
      Tab(0).Control(13)=   "Text102"
      Tab(0).Control(14)=   "Text101"
...
On Error Resume Next
    ...
    If Check101.Value = 1 Then
        ...
        Me.DTPicker102.Enabled = False
        Me.Text106.Enabled = False
        Me.Text107.Enabled = False
        Me.MaskEdBox101.Enabled = False
        Me.DTPicker103.Enabled = False
        Me.MaskEdBox102.Enabled = False
        
    Else
    
        Me.DTPicker102.Enabled = True
        Me.Text106.Enabled = True
        Me.Text107.Enabled = True
        Me.MaskEdBox101.Enabled = True
        Me.DTPicker103.Enabled = True
        Me.MaskEdBox102.Enabled = True
