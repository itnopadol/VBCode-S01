...
On Error GoTo ErrDescription
        ...
        '---------------------------------------------------------------------------------------------
                            vRepType = "RT"
                            If UCase(vGroupDoc) = "RHV" Or UCase(vGroupDoc) = "RAB" Or UCase(vGroupDoc) = "RXT" Or UCase(vGroupDoc) = "RDV" Or UCase(vGroupDoc) = "RDM" Then
                                vRepID = 64
                            ElseIf UCase(vGroupDoc) = "RHN" Or UCase(vGroupDoc) = "RDN" Then
                                vRepID = 65
                            ElseIf UCase(vGroupDoc) = "RCV" Or UCase(vGroupDoc) = "RVD" Then
                                vRepID = 135
