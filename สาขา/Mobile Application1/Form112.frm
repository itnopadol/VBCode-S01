...
If KeyAscii = 13 And Me.CMBWHCode.Text <> "" And Me.TextRow.Text <> "" Then
   ...
   vQuery = "exec dbo.USP_MB_SearchRow '" & vWHCode & "','" & vRow & "' "
   If OpenDataBase(gConnection, vRecordset, vQuery) <> 0 Then
      vCountRow = 1
   Else
      vCountRow = 0
...
If KeyAscii = 13 And Me.CMBWHCode.Text <> "" And Me.TextRow.Text <> "" And Me.TextShelf.Text <> "" Then
   vWHCode = Me.CMBWHCode.Text
   vRow = Me.TextRow.Text
   vShelf = Me.TextShelf.Text
   
   vQuery = "exec dbo.USP_MB_SearchShelfMaster '" & vWHCode & "','" & vRow & "','" & vShelf & "' "
   If OpenDataBase(gConnection, vRecordset, vQuery) <> 0 Then
      vCountShelf = 1
   Else
      vCountShelf = 0
