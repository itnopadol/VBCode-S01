...
Public Class FormReportSetConditionComm
    Dim ds As DataSet
    ...
    Private Sub FormReportSetConditionComm_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Public Sub PrintReport()
        ...
        vDocNo = vMemCampaignNo
        Dim rptDocument As New CrystalDecisions.CrystalReports.Engine.ReportDocument

        vQuery = "Exec dbo.USP_COM_CampaignSearch '" & vDocNo & "'"
        da = New SqlDataAdapter(vQuery, vConnection)
        ds = New DataSet
        da.Fill(ds)

        vReportName = "RP_COM_ConditionComm"
