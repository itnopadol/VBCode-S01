...
Public Class FormMain
    ...
    Private Sub MenuAddPayCoupon_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MenuAddPayCoupon.Click
        If frmCouponChinese Is Nothing Then
            frmCouponChinese = FormCouponChinese
        Else
            If frmCouponChinese.IsDisposed Then
                frmCouponChinese = FormCouponChinese
            End If
        End If
        frmCouponChinese.MdiParent = Me
        frmCouponChinese.Show()
        frmCouponChinese.BringToFront()


        'If frmBranchCouponChinese Is Nothing Then
        '    frmBranchCouponChinese = FormBranchCouponChines
        'Else
        '    If frmBranchCouponChinese.IsDisposed Then
        '        frmBranchCouponChinese = FormBranchCouponChines
        '    End If
        'End If
        'frmBranchCouponChinese.MdiParent = Me
        'frmBranchCouponChinese.Show()
        'frmBranchCouponChinese.BringToFront()
