...
Public Class FormReportPaidCommNet
    Dim ds As DataSet
    ...
    Private Sub FormReportPaidCommNet_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Public Sub PrintReport()
        ...
        vQuery = "Exec dbo.USP_COM_ComSummaryAll"
        da = New SqlDataAdapter(vQuery, vConnection)
        ds = New DataSet
        da.Fill(ds)

        vReportName = "RP_COM_PaySale"
    ...
    Private Sub Crystal101_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Crystal101.Load
