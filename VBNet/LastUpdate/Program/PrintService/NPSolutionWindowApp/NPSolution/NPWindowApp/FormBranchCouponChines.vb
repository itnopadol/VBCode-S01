...
Public Class FormBranchCouponChines
    Dim ds As DataSet
    ...
    Private Sub FormBranchCouponChines_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Public Sub vGetInvoiceData(ByVal vDocNo As String)
        ...
        da = New SqlDataAdapter(vQuery, bConnection)
        ds = New DataSet
        da.Fill(ds, "Docno")
        dt = ds.Tables("Docno")
        If dt.Rows.Count > 0 Then
            ...
            Me.TBSumItemAmount.Text = Format(vBillAmount, "##,##0.00")
    ...
    Private Sub BTNAddBill_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BTNAddBill.Click
        ...
        If Me.TBArName.Text <> "" And Me.ListViewItem.Items.Count > 0 And Me.TBSumItemAmount.Text <> "" Then
            ...
            If Me.TBDiscountAmount.Text <> "" Then
                vDisCountAmount = Me.TBDiscountAmount.Text
            End If

            If Me.TBDisCountCoupon.Text <> "" Then
                vCoupongAmount = Me.TBDisCountCoupon.Text
            End If
            ...
            If vNetAmount <= 0 Then
                MsgBox("เอกสารนี้ ไม่มีสินค้าหมวดทั่วไปหรือ มีส่วนลด หรือ ตัดคูปองไปแล้ว กรุณาตรวจสอบ", MsgBoxStyle.Critical, "Send Error Message")
                Me.TBDocNo.Focus()
                Exit Sub
            End If
            ...
            If Me.ListViewInvoice.Items.Count = 0 Then
                ...
                vListItem.SubItems.Add(2).Text = Format(vNetAmount, "##,##0.00")

                Call vCalcCoupon()

                Me.TBDocNo.Text = ""
                Me.TBSumItemAmount.Text = ""
                Me.TBDisCountCoupon.Text = ""
                Me.TBDiscountAmount.Text = ""
                Me.TBDocNo.Focus()
                Exit Sub
            End If
    ...
    Private Sub BTNSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BTNSave.Click
        ...
        If Me.ListViewInvoice.Items.Count > 0 Then
            For i = 0 To Me.ListViewInvoice.Items.Count - 1
                ...
                cmd = New SqlCommand(vQuery, bConnection)
                cmd.ExecuteNonQuery()
            Next
