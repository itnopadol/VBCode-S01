    ...
    Private Sub TBBarCode_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles TBBarCode.KeyDown
        ...
        If e.KeyCode = Keys.Enter Then
            ...
            If pds.Tables(0).Rows.Count > 0 Then
                ...
                vGetItemStatus = pds.Tables(0).Rows(0)("getitemstatus").ToString
                ...
                If vGetItemStatus <> 1 Then
                    Me.TBReOrder.Enabled = False
                    Me.TBQty.Enabled = False
                Else
                    Me.TBReOrder.Enabled = True
...
ErrDescription:
    ...
    Private Sub TBSuggest_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles TBSuggest.TextChanged
