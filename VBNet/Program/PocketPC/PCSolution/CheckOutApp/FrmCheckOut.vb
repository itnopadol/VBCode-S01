...
ErrDescription:
    ...
    Private Sub GenHoldingBill()
        ...
        If Me.ListViewMerge.Items.Count = 0 Then
            MsgBox("ไม่มีรายการสินค้าในตาราง ที่จะทำการพักบิล กรุณาตรวจสอบ", MsgBoxStyle.Critical, "Send Error Message")
            Exit Sub
        End If
        ...
        If vCheckZero = vCount Then
            MsgBox("รายการสินค้าไม่มีจำนวนที่จะไปทำการพักบิล กรุณาตรวจสอบ", MsgBoxStyle.Critical, "Send Error Message")
            If Me.ListViewMerge.Items.Count > 0 Then
        ...
        If vCount = vCheck Then
            ...
            Me.Cash03.Focus()
        Else
            MsgBox("รายการสินค้า ยังตรวจสอบไม่ครบ กรุณาตรวจสอบรายการสินค้าด้วย", MsgBoxStyle.Critical, "Send Error Message")
        ...
        If e.KeyCode = Keys.Enter Then
            If Me.TBSearchCheckOut.Text <> "" Then
                ...
                If vCountItem = 0 Then
                    MsgBox("ไม่มีรายการสินค้า ที่ต้องการ CheckOut", MsgBoxStyle.Critical, "Send Information Message")
                    Me.TBSearchCheckOut.Focus()
...
ErrDescription:
    ...
    Private Sub BTNCheckOut_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BTNCheckOut.Click
        ...
        MsgBox("ครั้งต่อไป ให้กดปุ่ม สีส้ม+หมายเลข 9 เพื่อทำการเลือกจุดพักบิล", MsgBoxStyle.Information, "Send Information Message")
...
ErrDescription:
    ...
    Private Sub BTNGenBill_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BTNGenBill.Click
        ...
        If Me.ListViewHolding.Items.Count > 0 Then
            ...
            MsgBox("ครั้งต่อไป ให้กดปุ่ม สีส้ม+หมายเลข 9 เพื่อทำการบันทึกใบพักบิลและทำการ CheckOut", MsgBoxStyle.Information, "Send Information Message")
            ...
            If vIsOpen = 0 Then
                ...
                MsgBox("บันทึกใบพักบิลเรียบร้อยแล้ว ได้เลขที่เอกสาร " & vDocNo & " ", MsgBoxStyle.Information, "Send Error Message")
                ...
                Me.TBSearchCheckOut.Focus()
            Else
                MsgBox("เอกสารที่บันทึกไปแล้วไม่สามารถบันทึกแก้ไขข้อมูลได้อีก ", MsgBoxStyle.Critical, "Send Error Message")
            End If
        End If
...
Line1:
                ...
                If vShelfUnit <> vUnitCode Then
                    ...
                    If vQTY > vTotalQTY Then
                        vAnswer = MsgBox("STOCK ไม่พอขาย ยังยืนยันการขายอยู่หรือไม่", MsgBoxStyle.YesNo, "Send Error Message ")
                        If vAnswer = 7 Then
...
Line1:
                ...
                Me.TBAddQTY.SelectAll()
            Else
                MsgBox("ไม่มี บาร์โค้ดสินค้า กรุณาตรวจสอบ", MsgBoxStyle.Critical, "Send Information Message")
                Me.TBSearchBarCode.Text = ""
                Me.TBSearchBarCode.Focus()
                Me.TBSearchBarCode.SelectAll()
                Exit Sub
...
ErrDescription:
    ...
    Private Sub RBCash1_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs)
        ...
        If e.KeyCode = Keys.Enter Then
            vAnswer = MsgBox("คุณต้องการ พักบิลที่แคชเชียร์จุดที่ 1 ใช่หรือไม่", MsgBoxStyle.YesNo, "Send Question Message")
            If vAnswer = 6 Then
...
ErrDescription:
    ...
    Private Sub BTNSearch_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BTNSearch.Click
        ...
        MsgBox("ครั้งต่อไป ให้กดปุ่ม สีส้ม+หมายเลข 2 เพื่อทำการค้นหาเลขที่ใบพักบิล", MsgBoxStyle.Information, "Send Information Message")
    ...
    Private Sub TBHoldSearch_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles TBHoldSearch.KeyDown
        ...
        If e.KeyCode = Keys.Enter Then
            If Me.TBHoldSearch.Text = "" Then
                MsgBox("ต้องกรอกคำที่ต้องการค้นด้วย", MsgBoxStyle.Critical, "Send Error Message")
                Exit Sub
            End If
            ...
            If Me.ListViewMerge.Items.Count > 0 Then
                If Me.TBCheckQty.Text <> "" Then
                    ...
                    If vQty <> vCountItem Then
                        ...
                        MsgBox("จำนวนที่ตรวจสอบไม่ตรงกับจำนวนที่จ่ายสินค้า", MsgBoxStyle.Critical, "Send Information Message")
                    Else
...
ErrDescription:
    ...
    Private Sub MenuMergeCancel_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        If Me.ListViewMerge.Items.Count > 0 Then
            ...
            vAnswer = MsgBox("คุณต้องการลบรายการที่ " & vIndex & " ใช่หรือไม่ ?", MsgBoxStyle.YesNo, "Send Question Message ?")
            If vAnswer = 6 Then
...
ErrDescription:
    ...
    Private Sub BTNHoldingClose_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BTNHoldingClose.Click
        ...
        MsgBox("ครั้งต่อไป ให้กดปุ่ม ESC เพื่อกลับไปหน้าจอเลือกคิวมา CheckOut", MsgBoxStyle.Information, "Send Information Message")
...
ErrDescription:
    ...
    Private Sub BTNExit_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BTNExit.Click
        ...
        MsgBox("ครั้งต่อไป ให้กดปุ่ม ESC เพื่อออกโปรแกรม", MsgBoxStyle.Information, "Send Information Message")
...
ErrDescription:
    ...
    Private Sub PrintHoldBill_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BTNPrintHoldBill.Click
        ...
        If Me.TBHoldNo.Text <> "" And Me.ListViewHolding.Items.Count > 0 And Me.TBHoldARName.Text <> "" Then
            ...
            MsgBox("ครั้งต่อไป ให้กดปุ่ม สีส้ม+หมายเลข 2 เพื่อทำการพิมพ์ทดแทน ใบพักบิล", MsgBoxStyle.Information, "Send Information Message")
            ...
            MsgBox("ส่งใบพักบิล ไปพิมพ์ทดแทนเรียบร้อยแล้ว ", MsgBoxStyle.Information, "Send Information Message")
        End If
