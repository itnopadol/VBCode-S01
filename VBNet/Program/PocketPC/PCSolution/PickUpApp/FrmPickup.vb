...
Line1:
            ...
            Else
                ...
                Me.TBBarCode.Focus()
                Me.TBBarCode.SelectAll()
                MsgBox("ไม่พบรหัสบาร์โค้ด กรุณาตรวจสอบ", MsgBoxStyle.Critical, "Send Error Message")
                Exit Sub
            End If
...
ErrDescription:
    ...
    Private Sub TBBarCode_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles TBBarCode.TextChanged
        ...
        If Me.TBRefNo.Text = "" Then
            MsgBox("กรุณากรอก ทะเบียนรถก่อนที่จะกรอกข้อมูลอื่น ๆ ทุกครั้ง", MsgBoxStyle.Critical, "Send Error Message")
            Me.TBRefNo.Focus()
            Exit Sub
        End If
...
ErrDescription:
    ...
    Private Sub BTNSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BTNSave.Click
        ...
        If Me.ListViewItem.Items.Count > 0 And Me.TBItemAmount.Text <> "" Then
            ...
            MsgBox("ครั้งต่อไป ให้กดปุ่ม สีส้ม+หมายเลข 9 เพื่อทำการบันทึกข้อมูล", MsgBoxStyle.Information, "Send Information Message")
            ...
            If Me.TBSaleCode.Text = "" Then
                MsgBox("กรุณากรอก รหัสพนักงานขาย ก่อนบันทึกข้อมูล", MsgBoxStyle.Critical, "Send Error Message")
                Me.TBSaleCode.Focus()
                Me.TBSaleCode.SelectAll()
                Exit Sub
            End If
...
Line1:
            ...
            End If
        Else
            MsgBox("ไม่มีรายการสินค้าให้บันทึกข้อมูล DriveThru กรุณาตรวจสอบ", MsgBoxStyle.Critical, "Send Error Message")
            Me.TBRefNo.Focus()
            Me.TBRefNo.SelectAll()
        End If
...
ErrDescription:
    ...
    Private Sub TBQTY_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles TBQTY.KeyDown
        ...
        If Me.TBRefNo.Text = "" Then
            MsgBox("ต้องกรอกทะเบียนรถหรือเลขที่อ้างอิงก่อน จึงจะเลือกหยิบสินค้าได้", MsgBoxStyle.Critical, "Send Error Message")
            Me.TBBarCode.Text = ""
            Me.TBRefNo.Focus()
            Exit Sub
        End If
        ...
        If e.KeyCode = Keys.Enter Then
            ...
            If vCheckPrice = 0 Then
                MsgBox("สินค้าดังกล่าวยังไม่ได้กำหนดราคาขาย กรุณาตรวจสอบ", MsgBoxStyle.Critical, "Send Error Message")
                Me.TBBarCode.Focus()
                Me.TBBarCode.SelectAll()
                Exit Sub
            End If
...
line2:
                ...
                If vQTY >= 10000 Then
                    MsgBox("จำนวนสินค้าที่ได้กรอกไป เกิน 10,000 กรุณาตรวจสอบให้แน่ใจอีกที", MsgBoxStyle.Information, "Send Error Message")
                End If
...
ErrDescription:
    ...
    Private Sub BTNClosePickup_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BTNClosePickup.Click
        ...
        MsgBox("ครั้งต่อไป ให้กดปุ่ม < เพื่อกลับไปยังหน้าเลือกจุด DriveThru หลังจากนั้นให้กด ปุ่ม ESC เพื่อออกโปรแกรม", MsgBoxStyle.Information, "Send Information Message")
...
ErrDescription:
    ...
    Private Sub TBEditQty_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles TBEditQty.KeyDown
        ...
        If e.KeyCode = Keys.Enter Then
            ...
            If vPickZone <> vLinePickZone Then
                MsgBox("สินค้าอยู่คนละโซน Drive Thru ไม่สามารถแก้ไขข้อมูลได้ Drive Thru ณ จุดไหนสามารถแก้ได้ ณ จุดนั้นเท่านั้น", MsgBoxStyle.Critical, "Send Error Message")
                Me.PNItemEdit.Visible = False
                Me.TBBarCode.Focus()
                Exit Sub
            End If
            ...
            End If
            If vQTY <= 0 Then
                MsgBox("ต้องกำหนดจำนวนที่ต้องการมากกว่า 0 เท่านั้น", MsgBoxStyle.Critical, "Send Error Message")
                Me.TBEditQty.Focus()
                Me.TBEditQty.SelectAll()
                Exit Sub
            End If
...
ErrDescription:
    ...
    Private Sub BTNClearPickUp_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BTNClearPickUp.Click
        ...
        MsgBox("ครั้งต่อไป ให้กดปุ่ม สีส้ม+หมายเลข 7 เพื่อทำการล้างหน้าจอ", MsgBoxStyle.Information, "Send Information Message")
...
ErrDescription:
    ...
    Private Sub BTNBack_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BTNBack.Click
        ...
        MsgBox("ครั้งต่อไป ให้กดปุ่ม < เพื่อกลับไปยังหน้าเลือกจุด DriveThru", MsgBoxStyle.Information, "Send Information Message")
...
ErrDescription:
    ...
    Private Sub BTNSearch_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BTNSearch.Click
        ...
        MsgBox("ครั้งต่อไป ให้กดปุ่ม สีส้ม+หมายเลข 1 เพื่อทำการค้นหาข้อมูล", MsgBoxStyle.Information, "Send Information Message")
            ...
            If Me.TBSaleCode.Text <> "" Then
                ...
                If InStr(vSearch, "/") <> 0 Then
                    ...
                    If ds.Tables(0).Rows.Count > 0 Then
                        ...
                        Me.TBBarCode.SelectAll()
                    Else
                        MsgBox("ไม่พบข้อมูลพนักงานขาย กรุณาตรวจสอบ", MsgBoxStyle.Critical, "Send Error Message")
                        Me.TBSaleCode.Focus()
                    End If
...
ErrDescription:
    ...
    Private Sub BTNSendAgain_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BTNSendAgain.Click
        ...
        If vIsOpen = 0 Then
            MsgBox("เอกสาร Drive Thru  ยังไม่ได้บันทึกข้อมูลไม่สามารถส่งคิว CheckOut กรุณาตรวจสอบ", MsgBoxStyle.Critical, "Send Error Message")
            Me.TBRefNo.Focus()
            Exit Sub
        End If

        MsgBox("ครั้งต่อไป ให้กดปุ่ม สีส้ม+หมายเลข 9 หรือ กดปุ่ม Enter เพื่อทำการส่งคิวรอ CheckOut", MsgBoxStyle.Information, "Send Information Message")
...
Line2:
            ...
            MsgBox("ส่งรายการสินค้าไปทำการ CheckOut เรียบร้อยแล้ว", MsgBoxStyle.Information, "Send Information Message")
        ...
        If vIsOpen = 1 Then
            If Me.TBRefNo.Text <> "" And Me.TBDocNo.Text <> "" And Me.ListViewItem.Items.Count > 0 Then
                ...
                If vCheckIsCancel = 1 Then
                    MsgBox("เลขที่เอกสารได้ทำการยกเลิกไปเรียบร้อยแล้ว ไม่สามารถยกเลิกเอกสารได้ กรุณาตรวจสอบ", MsgBoxStyle.Critical, "Send Error Message")
                    Me.TBRefNo.Focus()
                    Me.TBRefNo.SelectAll()
                    Exit Sub
                End If
                ...
                If vCheckIsConfirm = 1 And vCheckHoldBillNo <> "" Then
                    MsgBox("เลขที่เอกสารได้ทำการ ตรวจสอบสินค้าและทำเอกสารพักบิลเรียบร้อยแล้ว ไม่สามารถยกเลิกเอกสารได้ กรุณาตรวจสอบ", MsgBoxStyle.Critical, "Send Error Message")
                    Me.TBRefNo.Focus()
                    Me.TBRefNo.SelectAll()
                    Exit Sub
                End If

                vAnswer = MsgBox("คุณต้องการยกเลิกเอกสาร DriveThru เลขที่ " & vDocNo & " นี้ใช่หรือไม่", MsgBoxStyle.YesNo, "Send Query Message ?")
                ...
                Call AfterSaveData()
                Call ClearScreen()
                MsgBox("ยกเลิกเลขที่เอกสาร " & vDocNo & " เรียบร้อยแล้ว", MsgBoxStyle.Information, "Send Information Message")
                Me.TBRefNo.Focus()
                Me.TBRefNo.SelectAll()
            Else
                MsgBox("ข้อมูลของเอกสารมีไม่ครบ กรุณาตรวจสอบ", MsgBoxStyle.Information, "Send Information Message")
                Me.TBRefNo.Focus()
                Me.TBRefNo.SelectAll()
            End If
        End If
