...
Public Class FormReqCommission
    ...
    Private Sub BTNSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BTNSave.Click
        ...
        For i = 0 To Me.DGVItemDetails.RowCount - 1
            ...
            If Me.DGVItemDetails.Item(5, i).Value <> "" And vItemCode <> "" Then
            ...
            If Me.DGVItemDetails.Item(6, i).Value <> "" And vItemCode <> "" Then
...
Line1:
    ...
    Private Sub ListViewSearchDocNo_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles ListViewSearchDocNo.DoubleClick
        ...
        Dim i As Integer
        Dim vQty As Double
        Dim vRetailCom As String
        Dim vWholeSaleCom As String
        ...
        If Me.ListViewSearchDocNo.Items.Count > 0 Then
            ...
            If dt.Rows.Count > 0 Then
                ...
                For i = 0 To dt.Rows.Count - 1
                    ...
                    Me.DGVItemDetails.Item(5, i).Value = vRetailCom
                    Me.DGVItemDetails.Item(6, i).Value = vWholeSaleCom
                Next
