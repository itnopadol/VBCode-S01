...
Global ConnTempDB As New ADODB.Connection
...
Public Const dbTipPath = "\\nebula\BCS\Doc\dbTip.mdb"
...
Public Sub ConnectTemp()
    With ConnTempDB
        If .State = adStateOpen Then .Close
                .Provider = "SQLOLEDB"
                .Properties("Persist Security Info").Value = False
                .Properties("User ID").Value = "vbuser"
                .Properties("Password").Value = "132"
                .Properties("Data Source").Value = "Nebula"
                .Properties("Initial Catalog").Value = "TempDB"
                .CursorLocation = adUseClient
                .Open
    End With
End Sub
...
Public Sub InitializeDatabase()
    If vConnection.State = 0 Then
        vConnectionString = "Provider = SQLOLEDB.1;Persist Security Info = false;User ID = " & strUsername & ";Password = " & strPassword & ";Data Source = Nebula;Initial Catalog = BCNP"
