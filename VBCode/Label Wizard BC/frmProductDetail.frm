...
Begin VB.Form frmProductDetail 
   ...
   Begin VB.Label Label2 
      ...
      Caption         =   "*** ช่องของราคาตั้งต้องไม่เท่ากับ 0 "
      BeginProperty Font 
         Name            =   "MS Sans Serif"
         Size            =   14.25
         Charset         =   222
   ...
   Begin VB.Label Label1 
      BackStyle       =   0  'Transparent
      Caption         =   "*** รายการสินค้าที่จะพิมพ์ป้ายราคาได้ต้องมีข้อมูลครบทุกช่อง"
      BeginProperty Font 
         Name            =   "MS Sans Serif"
         Size            =   14.25
         Charset         =   222
...
Dim vPriceErect As Double
        ...
        'If Trim(LV_ProductDetail.SelectedItem.SubItems(6)) <> "" Then
        'vPriceErect = Trim(LV_ProductDetail.SelectedItem.SubItems(6))
        'Else
        'vPriceErect = 0
        'End If
        
        'If vPriceErect = 0 Then
        'MsgBox "สินค้าดังกล่าวไม่ได้ระบุราคาตั้ง หรือ กำหนดราคาตั้งไม่ตรงกับหน่วยนับ หรือ กำหนดรูปแบบผิด ต้องมีเฉพาะอักขระที่เกี่ยวกับตัวเลขเท่านั้น กรุณาตรวจสอบ", vbCritical, ""
        'Exit Sub
        'End If
        
        If Trim(LV_ProductDetail.SelectedItem.SubItems(7)) = "" Then
        MsgBox "สินค้าดังกล่าวไม่ได้ระบุที่เก็บสินค้า ต้องไประบุในโปรแกรม MobileApplication ในส่วนของระบุที่เก็บของสินค้า กรุณาตรวจสอบ", vbCritical, ""
        Exit Sub
        End If
