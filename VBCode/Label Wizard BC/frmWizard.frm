...
Begin VB.Form frmWizard 
   ...
   Begin VB.PictureBox PicWizard 
      ...
      Visible         =   0   'False
      Width           =   13470
      Begin VB.Frame FMSelectBay 
         Caption         =   "เลือก Bay ในการพิมพ์"
         BeginProperty Font 
            Name            =   "MS Sans Serif"
            Size            =   9.75
            Charset         =   222
         ...
         Visible         =   0   'False
         Width           =   13155
         Begin VB.CommandButton CMDSelectBayClose 
            Caption         =   "ออก"
            BeginProperty Font 
               Name            =   "MS Sans Serif"
               Size            =   9.75
            ...
            Width           =   1950
         End
         Begin VB.CommandButton CMDSelectBay 
            Caption         =   "เลือก Bay"
            BeginProperty Font 
               Name            =   "MS Sans Serif"
               Size            =   9.75
            ...
            Width           =   1950
         End
         Begin MSComctlLib.ListView ListViewBay 
            Height          =   4200
            Left            =   1710
            TabIndex        =   158
            Top             =   1080
   ...
   Begin VB.PictureBox PicWizard 
      ...
      Begin VB.CommandButton CMDPrintHandHeld 
         ...
         Width           =   1185
      End
      Begin VB.CommandButton CMDCloseHandHeld 
         Caption         =   "ปิด"
         BeginProperty Font 
            Name            =   "MS Sans Serif"
            Size            =   8.25
      ...
      Begin MSComctlLib.ImageList ImageList1 
         ...
         BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
            ...
            BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmWizard.frx":7B07
               Key             =   ""
            EndProperty
            BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmWizard.frx":A034
               Key             =   ""
            EndProperty
            BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmWizard.frx":C60E
               Key             =   ""
            EndProperty
            BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmWizard.frx":EA42
               Key             =   ""
            EndProperty
            BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmWizard.frx":10F2E
               Key             =   ""
            EndProperty
            BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmWizard.frx":110B0
               Key             =   ""
            EndProperty
            BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmWizard.frx":136AC
               Key             =   ""
            EndProperty
            BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmWizard.frx":13A6C
               Key             =   ""
            EndProperty
            BeginProperty ListImage9 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmWizard.frx":16004
               Key             =   ""
            EndProperty
         EndProperty
      End
...
ElseIf BartendorForm = "R5-1" Or BartendorForm = "R5-2" Or BartendorForm = "R5-3" Or BartendorForm = "R5-4" Or BartendorForm = "R5-5" Or BartendorForm = "R5-7" Or BartendorForm = "R5-8" Or BartendorForm = "R6-1" Or BartendorForm = "R6-2" Or BartendorForm = "R6-3" Or BartendorForm = "R6-4" Or BartendorForm = "R6-5" Or BartendorForm = "R6-6" Or BartendorForm = "R6-7" Or BartendorForm = "R6-8" Or BartendorForm = "R6-9" Then
strCreate_Temp = "select * into tempdb.dbo.Report_Temp2 From bcnp.dbo.NP_LABEL_TEMP where UsedUser = 'Null'"
ConnTempDB.Execute strCreate_Temp
strSQL = "Select * From NP_Label_Temp Where UsedUser = '" & strUsername & "' "
        Rs3.Open strSQL, ConnSQL, adOpenDynamic, adLockOptimistic
        If Not Rs3.EOF Then
                Rs3.MoveFirst
                While Not Rs3.EOF
                    If Int(Rs3!QTY) > 0 Then
                            ...
                            vQuery = "exec dbo.USP_NP_InsertPrintLabelLog '" & Trim(Rs3!Itemcode) & "','" & Trim(Rs3!Unitcode) & "','" & Trim(Rs3!barcode) & "','" & Trim(Rs3!UsedUser) & "', '" & BartendorForm & "' "
                            For iCount = 1 To Rs3!QTY
                                    ConnTempDB.Execute strSQL2
                                    
                                    ConnSQL.Execute vQuery
                            Next iCount
        ...
        End If
         Rs3.Close
ElseIf BartendorForm = "R7-1" Then
strCreate_Temp = "select * into tempdb.dbo.Report_Temp2 From bcnp.dbo.NP_LABEL_TEMP where UsedUser = 'Null'"
ConnTempDB.Execute strCreate_Temp
strSQL = "Select * From NP_Label_Temp Where UsedUser = '" & strUsername & "' "
        Rs3.Open strSQL, ConnSQL, adOpenDynamic, adLockOptimistic
...
End If
    ...
    'vRepName = "\\titanx\bartendor\" & "" & BartendorForm & ".dat"
    'vRepName = "\\galaxy\bartendor\" & "" & BartendorForm & ".dat"
    vRepName = "C:\bartendor\" & "" & BartendorForm & ".dat"
    Kill (vRepName)

'ImportBartendor.CreateTextFile ("\\galaxy\bartendor\" & BartendorForm & ".txt")
vRepName = "C:\bartendor\" & "" & BartendorForm & ".dat"
'ImportBartendor.CreateTextFile ("\\titanx\bartendor\" & BartendorForm & ".txt")
...
ErrDescription:
    If Err.Description <> "" Then
        If BartendorForm = "R2-8" Then
            ...
            ConnSQL.Execute strSQL
        ElseIf BartendorForm = "R5-1" Or BartendorForm = "R5-2" Or BartendorForm = "R5-3" Or BartendorForm = "R5-4" Or BartendorForm = "R5-5" Or BartendorForm = "R5-7" Or BartendorForm = "R5-8" Or BartendorForm = "R7-1" Or BartendorForm = "R6-1" Or BartendorForm = "R6-2" Or BartendorForm = "R6-3" Or BartendorForm = "R6-4" Or BartendorForm = "R6-5" Or BartendorForm = "R6-6" Or BartendorForm = "R6-7" Or BartendorForm = "R6-8" Or BartendorForm = "R6-9" Then
           strSQL = "Drop Table  tempdb.dbo.Report_Temp2 "
            ConnTempDB.Execute strSQL
       ElseIf BartendorForm = "R8-1" Then
...
Dim vRecordset As New ADODB.Recordset
Dim vQuery As String
Dim vListBay As ListItem
Dim i As Integer

On Error GoTo ErrDescription


ListViewBay.ListItems.Clear
vQuery = "exec dbo.usp_rc_bay"
If OpenDatabase(vConnection, vRecordset, vQuery) <> 0 Then
    vRecordset.MoveFirst
    i = 1
    While Not vRecordset.EOF
    Set vListBay = ListViewBay.ListItems.Add(, , i)
    vListBay.SubItems(1) = Trim(vRecordset.Fields("rowcode").Value)
    vListBay.SubItems(2) = Trim(vRecordset.Fields("bay").Value)
    vRecordset.MoveNext
    i = i + 1
    Wend
End If
...
Me.FMSelectBay.Visible = True
Me.ListViewBay.SetFocus
...
On Error Resume Next
    ...
    ConnSQL.Execute strSQL
    'ConnSQL.Close
    ElseIf BartendorForm = "R5-1" Or BartendorForm = "R6-1" Or BartendorForm = "R6-2" Or BartendorForm = "R6-3" Or BartendorForm = "R6-4" Or BartendorForm = "R6-5" Or BartendorForm = "R6-6" Or BartendorForm = "R6-7" Or BartendorForm = "R6-8" Or BartendorForm = "R6-9" Then
...
'On Error GoTo ErrDescription
        ...
        '------------------------------------------------------------------------------------
        If Trim(Name1) = "R2-8" Or Trim(Name1) = "R5-1" Or Trim(Name1) = "R5-2" Or Trim(Name1) = "R5-3" Or Trim(Name1) = "R8-1" Or Trim(Name1) = "R5-4" Or Trim(Name1) = "R5-5" Or Trim(Name1) = "R5-7" Or Trim(Name1) = "R5-8" Or Trim(Name1) = "R7-12" Or Trim(Name1) = "R6-1" Or Trim(Name1) = "R6-2" Or Trim(Name1) = "R6-3" Or Trim(Name1) = "R6-4" Or Trim(Name1) = "R6-5" Or Trim(Name1) = "R6-6" Or Trim(Name1) = "R6-7" Or Trim(Name1) = "R6-8" Or Trim(Name1) = "R6-9" Then
...
Private Sub CMDSelectBay_Click()
Dim vQuery As String
...
If Me.ListViewBay.ListItems.count > 0 Then
  For n = 1 To Me.ListViewBay.ListItems.count
    If Me.ListViewBay.ListItems(n).Checked = True Then
      vRow = Me.ListViewBay.ListItems(n).ListSubItems(1).Text
      vBay = Me.ListViewBay.ListItems(n).ListSubItems(2).Text
            
      vQuery = "exec dbo.usp_rc_bayaddshelf '" & vRow & "','" & vBay & "' "
      If OpenDatabase(vConnection, vRecordset, vQuery) <> 0 Then
          vRecordset.MoveFirst
          i = 1
          While Not vRecordset.EOF
        ...
        j = j + 1
        Set vListShelfBin = ListViewShelf2.ListItems.Add(, , j)
        vListShelfBin.SubItems(1) = Trim(vRecordset.Fields("code").Value)
        vListShelfBin.SubItems(2) = Trim(vRecordset.Fields("code").Value)
        vListShelfBin.SubItems(3) = Trim(vRecordset.Fields("whcode").Value)
        vListShelfBin.SubItems(4) = Trim(vRecordset.Fields("staff").Value)
...
Me.ListViewBay.ListItems.Clear

Me.FMSelectBay.Visible = False
End Sub

Private Sub CMDSelectBayClose_Click()
Me.FMSelectBay.Visible = False
End Sub
...
Dim vQuery As String
Dim vRecordset As New ADODB.Recordset
Dim vReocrdset1 As New ADODB.Recordset
    ...
    If vLenBarCode = 13 Then
        ...
        If OpenDatabase(vConnection, vReocrdset1, vQuery) <> 0 Then
            vAnswer = UCase(Trim(vReocrdset1.Fields("DegitAnswer").Value))
        End If
        vReocrdset1.Close
...
Private Sub Form_Load()
        ...
        Set ListX = ListView1.ListItems.Add(, , "Palm App", 5)
        Set ListX = ListView1.ListItems.Add(, , "ใบสั่งซื้อ", 5)
        Set ListX = ListView1.ListItems.Add(, , "ใบรับเข้า", 5)
        Set ListX = ListView1.ListItems.Add(, , "โปรโมชั่นหมดอายุ", 5)
        Set ListX = ListView1.ListItems.Add(, , "สินทรัพย์", 5)
        Set ListX = ListView1.ListItems.Add(, , "ใบสั่งขาย", 5)
        Set ListX = ListView1.ListItems.Add(, , "ใบขอโอน", 5)
        Set ListX = ListView1.ListItems.Add(, , "ปรับราคาประจำวัน", 5)
...
Private Sub Form_QueryUnload(Cancel As Integer, UnloadMode As Integer)
    ...
    ConnSQL.Execute strSQL
    'ConnSQL.Close
    ElseIf BartendorForm = "R5-1" Or BartendorForm = "R5-2" Or BartendorForm = "R5-3" Or BartendorForm = "R5-4" Or BartendorForm = "R5-5" Or BartendorForm = "R5-7" Or BartendorForm = "R6-1" Or BartendorForm = "R6-2" Or BartendorForm = "R6-3" Or BartendorForm = "R6-4" Or BartendorForm = "R6-5" Or BartendorForm = "R6-6" Or BartendorForm = "R6-7" Or BartendorForm = "R6-8" Or BartendorForm = "R6-9" Then
    strSQL = "Drop Table Report_Temp2"
    ConnSQL.Execute strSQL
    ElseIf BartendorForm = "R8-1" Then
    strSQL = "Drop Table Report_Temp3"
...
Private Sub BeginConnect()
        ...
        On Error GoTo ErrDescription
                ...
                '--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
                '--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
       'strSQL = "Select  ReportName, PathName From NP_Label_Setup Where StdIndex = '1'  and typelabel =1 order by reportname " ' คลัง
       strSQL = "Select  ReportName, PathName From NP_Label_Setup Where StdIndex = '1'  and typelabel =0 order by reportname" 'การตลาด
...
If Me.LV_Palm.ListItems.count > 0 Then
vIndex = Me.LV_Palm.SelectedItem.Index

vQty = InputBox("กรอกจำนวนที่ต้องการพิมพ์:", "กรอกจำนวนที่ต้องการเปลี่ยน")

If vQty > 0 Then
Me.LV_Palm.ListItems(vIndex).SubItems(5) = vQty
End If
End If
End Sub
        ...
        Else
                ...
                For iCount = Me.LV_TRF2.ListItems.count To 1 Step -1
                        If LV_TRF1.ListItems(Item.Index).SubItems(1) = LV_TRF2.ListItems.Item(iCount).SubItems(1) Then
                                LV_TRF1.ListItems.Remove (iCount)
                        End If
                Next iCount
        End If
...
Private Sub ChkPWD()
    ...
    With ConnChkPWD
        If .State = adStateOpen Then .Close
                ...
                .Properties("Data Source").Value = "Nebula" '"GALAXY"
...
CMBWH.Clear
vQuery = "exec dbo.USP_Label_SearchWarehouse"
If OpenDatabase(vConnection, vRecordset, vQuery) <> 0 Then
    vRecordset.MoveFirst
        While Not vRecordset.EOF
...
Private Sub AddTempPromotion()
        ...
        For iCount = 1 To ListResult.ListItems.count
            If Me.ListResult.ListItems(iCount).Checked = True Then
                ...
                tmpTHINAME = Left(tmpTHINAME, 3) & "." & Right(tmpTHINAME, 3)

                'strSQL = "USP_LB_InsertPrintShelf '" & tmpNUMBR & "','" & tmpTHINAME & "','" & tmpUsedUser & "','" & tmpSite & "' "
                
                strSQL = "exec dbo.USP_NP_InsertLabelTemp '" & tmpNUMBR & "','" & tmpBarcode & "','" & tmpTHINAME & "','',1,0,0,'','" & tmpUsedUser & "','','','','','',0,'','',0,'','','','' "
