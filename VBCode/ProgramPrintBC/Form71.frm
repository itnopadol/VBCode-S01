...
If TXT711.Text <> "" And TXT712.Text <> "" Then
    If TXT712.Text = "พิมพ์ใบนำฝากเงินสดธนาคารกรุงเทพ" Or TXT712.Text = "พิมพ์ใบนำฝากเงินสดธนาคารเอเซีย" Or TXT712.Text = "พิมพ์ใบนำฝากเงินสดธนาคารไทยพาณิชย์" Then
...
ListView711.ListItems.Clear
 vQuery = "exec dbo.USP_NP_SearchDocNotPrint  '" & vUserID & "' ,'" & vTypeDoc & "' "
...
On Error GoTo ErrDescription
        ...
        '---------------------------------------------------------------------------------------------
                            ...
                            ElseIf vFormPrint = "พิมพ์ใบนำฝากเงินสดธนาคารเอเซีย" Then
                                vRepID = 123
                            ElseIf vFormPrint = "พิมพ์ใบนำฝากเงินสดธนาคารไทยพาณิชย์" Then
                                vRepID = 487
                            Else
