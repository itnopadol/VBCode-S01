...
Begin VB.MDIForm MDIFrmProgramPrint 
   ...
   Begin VB.Menu Order2 
      ...
      End
      Begin VB.Menu Order2_11 
         Caption         =   "ยกเลิกอนุมัติใบสั่งซื้อ(Cat)"
      End
   ...
   Begin VB.Menu Order3 
      Caption         =   "จัดขาย"
      Begin VB.Menu Order3_16 
         Caption         =   "บันทึกใบเสนอราคา"
      End
      ...
      Begin VB.Menu Order3_20 
         Caption         =   "พิมพ์ใบกำกับภาษีอย่างเต็ม"
      End
   ...
   Begin VB.Menu Order4 
      ...
      End
      Begin VB.Menu Order43 
         Caption         =   "พิมพ์รายการเจ้าหนี้ค้างชำระ"
      End
      Begin VB.Menu Order44 
         Caption         =   "รายงานทำใบวางบิลประจำวัน ฝั่งเจ้าหนี้"
      End
      Begin VB.Menu Order45 
         Caption         =   "พิมพ์ จดหมายส่งคืนสินค้าให้กับเจ้าหนี้"
      End
   ...
   Begin VB.Menu Order5 
      ...
      Begin VB.Menu Order5_4 
         ...
         End
         Begin VB.Menu OrderARBalaneCredit 
            Caption         =   "รายงาน ยอดลูกหนี้คงค้างตามช่วงเครดิต"
         End
         Begin VB.Menu ARDebtMovementByMonth 
            Caption         =   "รายงาน ยอดลูกหนี้เคลื่อนไหวตามช่วงเดือน"
         End
         Begin VB.Menu ARReciptDaily 
   ...
   Begin VB.Menu Order7 
      ...
      End
      Begin VB.Menu Order073 
         Caption         =   "พิมพ์ใบถอนเงินสด"
      End
   End
   Begin VB.Menu Order8 
      ...
      Begin VB.Menu Order814 
         Caption         =   "พิมพ์ใบขอเบิกสินค้าและวัตถุดิบ"
      End
      Begin VB.Menu Order810 
         Caption         =   "ยกเลิกสินค้าค้างในใบขอเบิก/โอน สินค้า"
      End
   ...
   Begin VB.Menu Order9 
      ...
      End
      Begin VB.Menu AccountChecking 
         Caption         =   "ตรวจความถูกต้องเอกสารทางบัญชี"
      End
      Begin VB.Menu OrderPOSItem 
         Caption         =   "เปิดติดลบสินค้าขาย"
      End
      Begin VB.Menu Order991 
         Caption         =   "ยกเลิกอนุมัติเอกสารต่าง ๆ "
      End
      Begin VB.Menu PrintReserveInvoice 
         Caption         =   "พิมพ์ทดแทนเอกสารด้านขายของสาขา"
      End
   End
...
Private Sub AccountChecking_Click()
On Error GoTo ErrDescription

vFormActivate = "FrmAccountChecking"
Call ChekAuthorityAccess
If vAccess = 1 Then
    FrmAccountChecking.Show
    FrmAccountChecking.SetFocus
Else
...
Private Sub ARDebtMovementByMonth_Click()
FormARDebtMovementByMonth.Show
FormARDebtMovementByMonth.SetFocus
End Sub

Private Sub ARReciptDaily_Click()
FormARReceiptRemainDaily.Show
FormARReceiptRemainDaily.SetFocus
End Sub
...
Call ChekAuthorityAccess
If vAccess = 1 Or UCase(vUserID) = "THIPSUKONR" Or UCase(vUserID) = "TIPPAWANA" Then
Form02.Show
Form02.SetFocus
Else
    MsgBox "User ID : " & vUserID & " ไม่สามารถเข้าใช้หน้าจอนี้ได้ เนื่องจากไม่มีสิทธิ์การใช้งาน ", vbInformation, "ข้อความแจ้งเตือน"
...
Private Sub Order073_Click()
On Error GoTo ErrDescription

vFormActivate = "Form73"
Form73.Show
Form73.SetFocus
...
Private Sub Order2_10_Click()
Form2_10.Show
Form2_10.SetFocus
End Sub

Private Sub Order2_11_Click()
On Error GoTo ErrDescription

vFormActivate = "Form2_11"
'Call ChekAuthorityAccess
'If vAccess = 1 Then
Form2_11.Show
Form2_11.SetFocus
...
Private Sub Order40_7_Click()
On Error GoTo ErrDescription

'vFormActivate = "Form40_7"
'Call ChekAuthorityAccess
'If vAccess = 1 Then
    Form40_7.Show
    Form40_7.SetFocus
...
Private Sub Order45_Click()
FormPrintStkRefundLetter.Show
FormPrintStkRefundLetter.SetFocus
End Sub
...
Private Sub Order5_51_Click()
On Error GoTo ErrDescription

vFormActivate = "Form5_51"
'Call ChekAuthorityAccess
'If vAccess = 1 Then
Form5_51.Show
Form5_51.SetFocus
...
Call ChekAuthorityAccess
If vAccess = 1 Or vUserID = "kanjanaur" Then
Form6_0.Show
Form6_0.SetFocus
Else
    MsgBox "User ID : " & vUserID & " ไม่สามารถเข้าใช้หน้าจอนี้ได้ เนื่องจากไม่มีสิทธิ์การใช้งาน ", vbInformation, "ข้อความแจ้งเตือน"
...
'Else
    'MsgBox "User ID : " & vUserID & " ไม่สามารถเข้าใช้หน้าจอนี้ได้ เนื่องจากไม่มีสิทธิ์การใช้งาน ", vbInformation, "ข้อความแจ้งเตือน"
    MsgBox "User ID : " & vUserID & " ยกเลิกการใช้งาน ", vbInformation, "ข้อความแจ้งเตือน"
 '   Exit Sub
'End If
...
vFormActivate = "Form991"
Call ChekAuthorityAccess
If vAccess = 1 Or vUserID = "somrod" Then
Form991.Show
Form991.SetFocus
Else
    MsgBox "User ID : " & vUserID & " ไม่สามารถเข้าใช้หน้าจอนี้ได้ เนื่องจากไม่มีสิทธิ์การใช้งาน ", vbInformation, "ข้อความแจ้งเตือน"
...
Private Sub OrderARBalaneCredit_Click()
On Error GoTo ErrDescription

'vFormActivate = "Form811"
'Call ChekAuthorityAccess
'If vAccess = 1 Then
FormOrderARBalanceCreditday.Show
FormOrderARBalanceCreditday.SetFocus
'Else
 '   MsgBox "User ID : " & vUserID & " ไม่สามารถเข้าใช้หน้าจอนี้ได้ เนื่องจากไม่มีสิทธิ์การใช้งาน ", vbInformation, "ข้อความแจ้งเตือน"
  '  Exit Sub
'End If
...
If UCase(vUserID) = Trim(UCase("opporn")) Or UCase(vUserID) = Trim(UCase("vilaivan")) Or UCase(vUserID) = Trim(UCase("ampan")) Or (UCase(vUserID) = Trim(UCase("boontiwa")) Or UCase(vUserID) = Trim(UCase("chenchira")) Or UCase(vUserID) = Trim(UCase("jip"))) Or UCase(vUserID) = Trim(UCase("somrod")) Or UCase(vUserID) = Trim(UCase("porntip")) Or UCase(vUserID) = Trim(UCase("yuraporn")) Or UCase(vUserID) = Trim(UCase("sompornss")) Or UCase(vUserID) = Trim(UCase("nittaya")) Then
...
Private Sub PrintReserveInvoice_Click()
On Error GoTo ErrDescription

'vFormActivate = "FormStockCardBC"
'Call ChekAuthorityAccess
'If vAccess = 1 Then
FormPrintReserveInvoice.Show
FormPrintReserveInvoice.SetFocus
'Else
 '   MsgBox "User ID : " & vUserID & " ไม่สามารถเข้าใช้หน้าจอนี้ได้ เนื่องจากไม่มีสิทธิ์การใช้งาน ", vbInformation, "ข้อความแจ้งเตือน"
  '  Exit Sub
'End If
