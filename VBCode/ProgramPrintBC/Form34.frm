...
Begin VB.Form Form34 
   ...
   Begin Crystal.CrystalReport CrystalReport344 
      Left            =   3840
      Top             =   7080
      _ExtentX        =   741
      _ExtentY        =   741
   ...
   End
   Begin Crystal.CrystalReport CrystalReport343 
      Left            =   2520
      Top             =   7320
      _ExtentX        =   741
      _ExtentY        =   741
...
If Trim(TXT341.Text) <> "" And Trim(TXT342.Text) <> "" Then
   ...
   End If
    ...
    If Trim(TXT342.Text) = Trim("พิมพ์ใบเสร็จ+ใบจ่ายสินค้า") Then
      ...
      'If OpenDataBase(gConnection, vRecordset, vQuery) <> 0 Then
       ' vRecordset.MoveFirst
        ...
        'vZoneID(i) = Trim(vRecordset.Fields("zoneid").Value)
      ...
      'If vShelfCode(i) = "AVL" Then
       '     If vPickZone(i) = "01" Then
        '        Call PrintItem_AVL01(vWHCode(i), vPickZone(i), vZoneID(i))
         '   End If
            
          '  If vPickZone(i) = "02" Then
           '     Call PrintItem_AVL02(vWHCode(i), vPickZone(i), vZoneID(i))
            'End If
      'ElseIf vShelfCode(i) = "BAK" Then
       '     If vPickZone(i) = "01" Then
        '        Call PrintItem_BAK01(vWHCode(i), vPickZone(i), vZoneID(i))
         '   End If
          
          '  If vPickZone(i) = "02" Then
           '     Call PrintItem_BAK02(vWHCode(i), vPickZone(i), vZoneID(i))
            'End If
            
            'If vPickZone(i) = "04" Then
             '   Call PrintItem_BAK04(vWHCode(i), vPickZone(i), vZoneID(i))
            'End If
            
            'If vPickZone(i) = "05" Then
             '   Call PrintItem_BAK05(vWHCode(i), vPickZone(i), vZoneID(i))
            'End If
            'If vPickZone(i) = "06" Then
             '   Call PrintItem_BAK06(vWHCode(i), vPickZone(i), vZoneID(i))
            'End If
      'ElseIf vShelfCode(i) = "SPO" Then
       '   Call PrintItem_SPO(vWHCode(i), vPickZone(i), vZoneID(i))
      'ElseIf vShelfCode(i) = "OFS" Then
       '   Call PrintItem_OFS(vWHCode(i), vPickZone(i), vZoneID(i))
      'ElseIf vShelfCode(i) = "SHW" Then
       '   Call PrintItem_SHW(vWHCode(i), vPickZone(i), vZoneID(i))
      'ElseIf vShelfCode(i) = "RSV" Then
       '   Call PrintItem_RSV(vWHCode(i), vPickZone(i), vZoneID(i))
      'ElseIf vShelfCode(i) = "DMG" Then
       '   Call PrintItem_DMG(vWHCode(i), vPickZone(i), vZoneID(i))
      'ElseIf vShelfCode(i) = "VND" Then
       '   Call PrintItem_VND(vWHCode(i), vPickZone(i), vZoneID(i))
      'End If
      'Next i
    ...
    ElseIf Trim(TXT342.Text) = Trim("พิมพ์ใบเสร็จ") Then
      Call PrintInvoice
    ElseIf Trim(TXT342.Text) = Trim("พิมพ์ใบเสร็จ ไดรฟ์ทรู") Then
      Call PrintInvoice_DriveThru
    ElseIf Trim(TXT342.Text) = Trim("พิมพ์ใบเสร็จ แยกนอก") Then
      Call PrintInvoice_TaxSeparation
...
Public Sub PrintItem_AVL01(WHCode As String, vPickZone As String, vZoneID As String)
...
vQuery = "exec dbo.USP_INV_InsertPrintSlip1 '" & vDocNo & "','" & vGenerateNumber & "','" & vWHCode & "','" & vShelfCode & "','" & vZoneID & "','" & vPickZone & "','','" & vUserID & "' "
gConnection.Execute vQuery
...
If OpenDataBase(gConnection, vRecordset, vQuery) <> 0 Then
    With CrystalReport341
        ...
        .ParameterFields(2) = "@vPickZone;" & vPickZone & ";true"
...
Public Sub InsertPayNumber(vDocNo As String, vWHCode As String, vShelfCode As String, vZoneID As String, vPickZone As String)
Dim vQuery As String
Dim vRecordset As New ADODB.Recordset
Dim vAutoNumber As String, vDocNo1 As String, vDocGroup1 As String
Dim vCheck As Integer
...
Public Sub InsertInvoicePayNumber(vDocNo As String, vWHCode As String, vShelfCode As String, vFamilyCode As String, vZoneID As String, vPickZone As String)
Dim vQuery As String
...
vQuery = "exec dbo.USP_NP_SearchMaxZoneNumber  '" & vZoneID & "' "
If OpenDataBase(gConnection, vRecordset1, vQuery) <> 0 Then
    vNextZoneNumber = Trim(vRecordset1.Fields("zonenumber").Value)
    
    vExQuery = "exec dbo.USP_NP_UpdatePayGoodRunningZone '" & vDocNo & "','" & vWHCode & "','" & vShelfCode & "','" & vZoneID & "','" & vPickZone & "','" & vGenerateNumber & "'," & vNextZoneNumber & " "
...
Public Sub InsertPayNumberZone(vDocNo As String, vWHCode As String, vShelfCode As String, vFamilyCode As String, vZoneID As String, vPickZone As String, PayNumber As String)
Dim vQuery As String
Dim vRecordset As New ADODB.Recordset
Dim vRecordset1 As New ADODB.Recordset
Dim vAutoNumber As String, vDocNo1 As String, vDocGroup1 As String
...
vQuery = "exec dbo.USP_INV_SearchInvoicePrintSlip '" & vDocNo & "' "
If OpenDataBase(gConnection, vRecordset, vQuery) <> 0 Then
vRecordset.MoveFirst
vCountShelfCode = 0
For i = 1 To vRecordset.RecordCount
  vWHCode(i) = Trim(vRecordset.Fields("whcode").Value)
  vShelfCode(i) = Trim(vRecordset.Fields("shelfcode").Value)
  vFamilyCode(i) = Trim(vRecordset.Fields("familycode").Value)
  vPickZone(i) = Trim(vRecordset.Fields("pickzone").Value)
  vZoneID(i) = Trim(vRecordset.Fields("zoneid").Value)
  vCountShelfCode = vCountShelfCode + 1
vRecordset.MoveNext
...
Call InsertInvoicePayNumber(vDocNo, vWHCode(i), vShelfCode(i), vFamilyCode(i), vZoneID(i), vPickZone(i))
...
'If vShelfCode(i) = "AVL" Then
 ' If vPickZone(i) = "01" Then
  '  Call InsertPayNumber(vDocNo, vWHCode(i), vShelfCode(i), vZoneID(i), vPickZone(i))
  'End If
...
Public Sub PrintItem_AVL02(WHCode As String, vPickZone As String, vZoneID As String)
Dim vReportName As String
Dim vDocNo As String
Dim vRepID As Integer
Dim vRepType As String
...
Public Sub PrintItem_BAK01(WHCode As String, vPickZone As String, vZoneID As String)
Dim vReportName As String
Dim vDocNo As String
Dim vRepID As Integer
Dim vRepType As String
...
Public Sub PrintItem_BAK02(WHCode As String, vPickZone As String, vZoneID As String)
Dim vReportName As String
Dim vDocNo As String
Dim vRepID As Integer
Dim vRepType As String
...
Public Sub PrintItem_BAK04(WHCode As String, vPickZone As String, vZoneID As String)
Dim vReportName As String
Dim vDocNo As String
Dim vRepID As Integer
Dim vRepType As String
...
Public Sub PrintItem_BAK05(WHCode As String, vPickZone As String, vZoneID As String)
Dim vReportName As String
Dim vDocNo As String
Dim vRepID As Integer
Dim vRepType As String
...
Public Sub PrintItem_BAK06(WHCode As String, vPickZone As String, vZoneID As String)
Dim vReportName As String
Dim vDocNo As String
Dim vRepID As Integer
Dim vRepType As String
...
Public Sub PrintItem_SPO(WHCode As String, vPickZone As String, vZoneID As String)
Dim vReportName As String
Dim vDocNo As String
Dim vRepID As Integer
Dim vRepType As String
...
Public Sub PrintItem_DMG(WHCode As String, vPickZone As String, vZoneID As String)
Dim vReportName As String
Dim vDocNo As String
Dim vRepID As Integer
Dim vRepType As String
...
Public Sub PrintItem_VND(WHCode As String, vPickZone As String, vZoneID As String)
Dim vReportName As String
Dim vDocNo As String
Dim vRepID As Integer
Dim vRepType As String
...
Public Sub PrintItem_OFS(WHCode As String, vPickZone As String, vZoneID As String)
Dim vReportName As String
Dim vDocNo As String
Dim vRepID As Integer
Dim vRepType As String
...
Public Sub PrintItem_SHW(WHCode As String, vPickZone As String, vZoneID As String)
Dim vReportName As String
Dim vDocNo As String
Dim vRepID As Integer
Dim vRepType As String
...
Public Sub PrintItem_RSV(WHCode As String, vPickZone As String, vZoneID As String)
Dim vReportName As String
Dim vDocNo As String
Dim vRepID As Integer
Dim vRepType As String
...
' vQuery = "Select Docno,LastPrintDateTime,name1,printed  from BCNP.dbo.vw_sl_00001 where Printed = 0  " _
   '                     & " and LastPrintedUser = '" & vUserID & "' and DoctypeID = '" & vTypeDoc & "'  order by LastPrintDateTime "
        ...
        vQuery = "exec dbo.USP_NP_SearchPrintDocNo '" & vUserID & "','" & vTypeDoc & "' "
        If OpenDataBase(gConnection, vRecordset, vQuery) <> 0 Then
...
Public Sub PrintInvoice_TaxSeparation()
        Dim vQuery As String
        Dim vRecordset As New ADODB.Recordset
        Dim vDocNo As String
        Dim vGroupDoc As String
...
On Error GoTo ErrDescription
        ...
        vQuery = "exec dbo.USP_NP_SearchPrintDocNo '" & vUserID & "','" & vDocHeader & "' "
        If OpenDataBase(gConnection, vRecordset, vQuery) <> 0 Then
                    If Not vRecordset.EOF Then
