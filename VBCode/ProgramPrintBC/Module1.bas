...
Global BIConnectionString As String
Global DevConnectionString As String
Global XPCConnectionString As String
Global gConnection As New ADODB.Connection
Global biConnection As New ADODB.Connection
Global vConnection As New ADODB.Connection
Global vVatConnection As New ADODB.Connection
Global vBIConnection As New ADODB.Connection
Global vDevConnection As New ADODB.Connection
Global vXPCConnection As New ADODB.Connection
...
VatConnectionString = "Provider=SQLOLEDB.1;Persist Security Info =false;User ID=sa;Password='';Data Source = BI;Initial Catalog = BCVAT"
...
Public Sub InitializeDataBaseBI()
If vBIConnection.State <> 0 Then
vBIConnection.Close
BIConnectionString = "Provider=SQLOLEDB.1;Persist Security Info =false;User ID=sa;Password='[ibdkifu';Data Source = BI;Initial Catalog = BCVAT"
vBIConnection.Open (BIConnectionString)
Else
BIConnectionString = "Provider=SQLOLEDB.1;Persist Security Info =false;User ID=sa;Password='[ibdkifu';Data Source = BI;Initial Catalog = BCVAT"
vBIConnection.Open (BIConnectionString)
End If
...
Public Sub InitializeDataBaseDev()
If vDevConnection.State <> 0 Then
vDevConnection.Close
DevConnectionString = "Provider=SQLOLEDB.1;Persist Security Info =false;User ID=VBUser;Password='132';Data Source = BI;Initial Catalog = BCVat"
vDevConnection.Open (DevConnectionString)
Else
DevConnectionString = "Provider=SQLOLEDB.1;Persist Security Info =false;User ID=VBUser;Password='132';Data Source = BI;Initial Catalog = BCVat"
vDevConnection.Open (DevConnectionString)
End If
...
Public Sub InitializeDataBaseXPC()
If vXPCConnection.State <> 0 Then
vXPCConnection.Close
XPCConnectionString = "Provider=SQLOLEDB.1;Persist Security Info =false;User ID=VBUser;Password='132';Data Source = Nebula;Initial Catalog = XPC"
vDevConnection.Open (XPCConnectionString)
Else
XPCConnectionString = "Provider=SQLOLEDB.1;Persist Security Info =false;User ID=VBUser;Password='132';Data Source = Nebula;Initial Catalog = XPC"
vXPCConnection.Open (XPCConnectionString)
End If
End Sub
...
Public Function OpenDataBaseDev(vDevConnection As ADODB.Connection, gDevRecordset As ADODB.Recordset, vQuery As String) As String
vDevConnection.CursorLocation = adUseClient
gDevRecordset.Open vQuery, vDevConnection, adOpenDynamic, adLockOptimistic
OpenDataBaseDev = gDevRecordset.RecordCount
End Function
...
Public Function OpenDataBaseXPC(vXPCConnection As ADODB.Connection, gXPCRecordset As ADODB.Recordset, vQuery As String) As String
vXPCConnection.CursorLocation = adUseClient
gXPCRecordset.Open vQuery, vXPCConnection, adOpenDynamic, adLockOptimistic
OpenDataBaseXPC = gXPCRecordset.RecordCount
End Function

Public Function OpenDataBaseBI(biConnection As ADODB.Connection, vRecordset As ADODB.Recordset, vQuery As String) As String
biConnection.CursorLocation = adUseClient
vRecordset.Open vQuery, biConnection, adOpenDynamic, adLockOptimistic
OpenDataBaseBI = vRecordset.RecordCount
End Function
...
vConnectionString = Trim("Provider = SQLOLEDB.1;Persist security Info = False;User ID='vbuser';Password = '132';Data Source = Nebula;Initial Catalog = BCNP")
