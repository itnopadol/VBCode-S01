...
Begin VB.Form Form2_4 
   ...
   Begin VB.OptionButton OPTConcrete 
      BackColor       =   &H00FFFFFF&
      Caption         =   "ใบตรวจรับคลัง PASS-คอนกรีต"
      BeginProperty Font 
         Name            =   "MS Sans Serif"
         Size            =   14.25
         Charset         =   222
...
On Error Resume Next
    ...
    End If 'เช็คว่าพิมพ์ครั้งแรกหรือ ทดแทน
        ...
        If vRepID = 0 Then
            MsgBox "เลือกฟอร์มใบตรวจรับผิดประเภท กรุณาตรวจสอบ", vbCritical, "Send Error Message"
            Exit Sub
        End If
