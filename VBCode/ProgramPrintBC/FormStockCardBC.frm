...
Begin VB.Form FormStockCardBC 
   ...
   Begin VB.PictureBox PICSearchItem 
      Height          =   9060
      Left            =   0
      Picture         =   "FormStockCardBC.frx":9673
      ScaleHeight     =   9000
      ScaleWidth      =   12015
      TabIndex        =   19
      Top             =   0
      ...
      Begin VB.CommandButton CMDClickSearch 
         Height          =   285
         Left            =   5805
         Picture         =   "FormStockCardBC.frx":12CE6
         Style           =   1  'Graphical
         TabIndex        =   26
         Top             =   2070
         Width           =   375
   ...
   Begin VB.CommandButton CMDSearchWHCode2 
      Height          =   285
      Left            =   5355
      Picture         =   "FormStockCardBC.frx":130B3
      Style           =   1  'Graphical
      TabIndex        =   6
      Top             =   3060
      Width           =   375
   ...
   Begin VB.CommandButton CMDSearchItemCode 
      Height          =   285
      Left            =   5940
      Picture         =   "FormStockCardBC.frx":13480
      Style           =   1  'Graphical
      TabIndex        =   2
      Top             =   1890
      Width           =   330
   ...
   Begin VB.CommandButton CMDSearchWHCode1 
      Height          =   285
      Left            =   5355
      Picture         =   "FormStockCardBC.frx":1384D
      Style           =   1  'Graphical
      TabIndex        =   4
      Top             =   2700
      Width           =   375
...
vQuery = "select  * from npmaster.dbo.TB_NP_BCDataConnection where  servername = 'nebula' order by companyname"
If OpenDataBase(gConnection, vRecordset, vQuery) <> 0 Then
 vRecordset.MoveFirst
 While Not vRecordset.EOF
