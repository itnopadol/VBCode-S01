...
If ListView102.ListItems.Count <> 0 And Text103.Text <> "" Then
    For i = ListView102.ListItems.Count To 1 Step -1
            ...
            If InStr(Trim(Me.Text101.Text), "/") <> 0 Then
            'vPromotionName = Right(Me.Text101.Text, Len(Me.Text101.Text) - InStr(Trim(Me.Text101.Text), "/"))
            vPromotionName = Me.Text101.Text
            End If
...
MsgBox "เอกสารหมดอายุไม่สามารถพิมพ์ป้ายราคาพิเศษได้ กรุณาตรวจสอบ", vbCritical, "Send Error Message"
Exit Sub
End If
