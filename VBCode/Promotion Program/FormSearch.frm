...
If OpenDatabase(gConnection, vRecordset, vQuery) <> 0 Then
    ...
    While Not vRecordset.EOF
        ...
        End If
        If Not IsNull(Trim(vRecordset.Fields("pm_type").Value)) Then
        vListPromotion.SubItems(5) = Trim(vRecordset.Fields("pm_type").Value)
        Else
        vListPromotion.SubItems(5) = ""
        End If
    vRecordset.MoveNext
    Wend
End If
...
If Trim(ListView101.ListItems.Item(vIndex).SubItems(5)) = "" Then
Form101.CMBPromoType.Text = ""
Else
Form101.CMBPromoType.ListIndex = Trim(ListView101.ListItems.Item(vIndex).SubItems(5))
End If
